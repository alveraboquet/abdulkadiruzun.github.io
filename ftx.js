setInterval(function()
{
  for (let i = 0; i < 24; i++)
  {
   for(let k =0; k<61; k++)
   {
    if (document.getElementsByClassName("coinsf")[i].innerHTML == document.getElementsByClassName("coins")[k].innerHTML)
    {
      document.getElementsByClassName("mercurBuyf")[i].innerHTML        = document.getElementsByClassName("mercurBuy")[k].innerHTML;
      document.getElementsByClassName("mercurbuyVolumef")[i].innerHTML  = document.getElementsByClassName("mercurbuyVolume")[k].innerHTML;
      document.getElementsByClassName("mercurSellf")[i].innerHTML       = document.getElementsByClassName("mercurSell")[k].innerHTML;
      document.getElementsByClassName("mercursellVolumef")[i].innerHTML = document.getElementsByClassName("mercursellVolume")[k].innerHTML;
    }
   }
  }
}, 900);
...
// https://ftx.com/api/markets/GMT_USD/orderbook?depth=10