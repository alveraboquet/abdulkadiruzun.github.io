  ...
  setInterval(function () {
    ...
    for (var i = 0; i < 61; i++) {
      ...
      var mercurbuyfloat = parseFloat(
        document.getElementsByClassName("mercurBuy")[i].innerText
      ); // mercurden alış
      var gatesellfloat = parseFloat(
        document.getElementsByClassName("gateSell")[i].innerText
      ); // gate de satış

      var mercurbuyVolume = parseFloat(
        document.getElementsByClassName("mercurbuyVolume")[i].innerText
      ); //mercurden alınan hacım
      var gatesellVolume = parseFloat(
        document.getElementsByClassName("gatesellVolume")[i].innerText
      ); // gateden satılabilen hacım

      //Kaarı adetle çarpıyoruz.
      var kaarTers = (document.getElementsByClassName("profitableTers")[
        i
      ].innerHTML = (
      ...
      var gatebuyfloat = parseFloat(
        document.getElementsByClassName("gateBuy")[i].innerText
      );
      var mercursellfloat = parseFloat(
        document.getElementsByClassName("mercurSell")[i].innerText
      );

      var gateBuyVolume = parseFloat(
        document.getElementsByClassName("gatebuyVolume")[i].innerText
      );
      var mercursellVolume = parseFloat(
        document.getElementsByClassName("mercursellVolume")[i].innerText
      );

      //Kaarı adetle çarpıyoruz
      var kaarDüz = (document.getElementsByClassName("profitableDüz")[
        i
      ].innerHTML = (
      ...
      if (kaarDüz > 0) {
        document.getElementsByClassName("profitableDüz")[i].style.color =
          "#0cb056";
        document.getElementsByClassName("profitableDüz")[i].style.fontSize =
          "large";
      } else {
        document.getElementsByClassName("profitableDüz")[i].style.color =
          "#ba041c";
      ...
      if (kaarTers > 0) {
        document.getElementsByClassName("profitableTers")[i].style.color =
          "#0cb056";
        document.getElementsByClassName("profitableTers")[i].style.fontSize =
          "large";
      } else {
        document.getElementsByClassName("profitableTers")[i].style.color =
          "#ba041c";
